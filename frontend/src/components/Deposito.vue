<template>
    <main>
        ...
        <div v-if="mostrarSucesso" class="filter-download">
            <p class="title-popup">Depósito realizado com sucesso</p>
    ...
    methods: {
        ...
        async depositar() {
            ...
            try {
                ...
                const response = await axios.post('http://localhost:8080/transacoes/deposito/' + this.empresaId + '/' + this.clienteId, this.valor, {
                    headers: {
